...
<header class="sticky" id="home">
        ...
        <ul class="navlist">
            <li><a href="#today">Today Appointment</a></li>
    ...
    ?>
            ...
            <div><a href="check.php?id=<?php echo $row['id']; ?>"><button id="btn">Checked</button></a>
                </div>
                <div><a href="delete.php?id=<?php echo $row['id']; ?>"><button id="button">Delete</button></a>
                </div>    
