...
<div class="staff" >
            <div class="staff1">
                <div>
                <div class="text">DR.KRISH DHANANI</div>
            ...
            <div class="staff2">
                <div>
                <div class="text">DR.NIHAR AKOLIYA</div>
                        <div class="text">5 YEAR EXPERIENCE</div>
                </div>
            ...
            <div class="staff3">
                <div>
                <div class="text">AMISHA SORATHIYA</div>
                        <div class="text">2 YEAR EXPERIENCE</div>
                </div>
            ...
            <div class="staff4">
                <div>
                <div class="text">HARSHITA DESAI</div>
                        <div class="text">3 YEAR EXPERIENCE</div>
                </div>
...
<div class="frame">
        ...
        <div class="frame">
            <div class="frame-pic">
                <img src="glass.jpg" height="100px">
            </div>
            <div class="frame-name">
            AVIATOR
            </div>
        ...
        <div class="frame">
            <div class="frame-pic">
                <img src="frame2.jpg" height="100px">
            </div>
            <div class="frame-name">
            SQUARE
            </div>
        ...
        <div class="frame">
            <div class="frame-pic">
                <img src="frame4.jpg" height="100px">
            </div>
            <div class="frame-name">
             RECTANGLE
            </div>
